...
namespace TTS_server_alap_alpha_v1
{
    public class PdfMode
    {
        ...
        public PdfMode(String latexSourceCode)
        {
            this.latexSourceCode = latexSourceCode;
        }

        public string filterLatexSourceCodeUsingOpenDetex()
        {
            try
            {
                ...
                //string path = @"D:\Workspace\TTS\TTS_server_alap_alpha_v1\";
                ...
                string pathTex = @"D:\Workspace\TTS\TTS_server_alap_alpha_v1\";
        ...
        private static String StartDeTexProcess()
        {
            ...
            try
            {
                ...
                string detexPath = @"D:\Workspace\TTS\TTS_server_alap_alpha_v1\opendetex";
                psiWindows = new ProcessStartInfo("cmd.exe", "/K " + "cd " + "D:");
                //psiWindows = new ProcessStartInfo("cmd.exe", "/K " + "cd " + @"D:\Workspace\TTS\TTS_server_alap_alpha_v1\opendetex");
                ...
                pWindows.StandardInput.WriteLine("D:");
                pWindows.StandardInput.WriteLine(@"cd D:\Workspace\TTS\TTS_server_alap_alpha_v1\opendetex");
